...
variable "cluster_version" {
  ...
  description = "Default platform name. Valid options are `linux`"
  type        = string
  default     = "linux"
}
...
variable "workers_group_defaults" {
  description = "Override default values for target groups. See workers_group_defaults in local.tf for valid keys."
  type        = any
  default     = {}
}
